...
public class Client implements ActionListener{
    ...
    Client(){
        ...
        ImageIcon profile = new ImageIcon(ClassLoader.getSystemResource("icons/2.png"));
        ...
        frame.setLocation(800,30);         // set Location of the frame because i want to display it on center of the screen 
    ...
    public static void main(String[] args){
        ...
        try{
             ...
             // to take the input of server class 
             ...
             while(true){
                 ...
                 JPanel leftPanel = formatLabel(clientMsg); // it automatically decorate the message box
                 
                 // add leftPanel to the left corner then 
                 verticalBox.add(leftPanel);
                 verticalBox.add(Box.createVerticalStrut(15));
                 
                 JPanel msgBoxLeft = new JPanel(new BorderLayout());
                 msgBoxLeft.add(leftPanel, BorderLayout.LINE_START ); // add the incoming message to the left of the box 
                 verticalBox.add(msgBoxLeft);
                 
                
                 frame.validate(); // automatically refresh the page after adding every msg to the frame 
             }
